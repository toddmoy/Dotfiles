...
exports.applySnippetWorkspaceEdit = exports.isSnippetEdit = exports.checkForMinimalColorTheme = exports.checkForOtherPrismaExtension = exports.isDebugOrTestSession = void 0;
...
function checkForOtherPrismaExtension() {
    const files = fs_1.readdirSync(path_1.default.join(os_1.homedir(), '.vscode/extensions')).filter((fn) => fn.toLowerCase().startsWith('prisma.prisma-') &&
        !fn.toLowerCase().startsWith('prisma.prisma-insider-'));
    if (files.length !== 0) {
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        vscode_1.window.showInformationMessage(`You have both the Insider and stable Prisma VSCode extension installed. Please uninstall or disable one of them for a better experience.`);
