...
function activate(docUri) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ext = vscode_1.default.extensions.getExtension('Prisma.prisma');
        yield ext.activate();
        try {
            ...
            yield sleep(3000); // Wait for server activation
        }
        catch (e) {
            console.error(e);
        }
...
exports.getDocPath = (p) => {
    return path_1.default.resolve(__dirname, '../../testFixture', p);
};
exports.getDocUri = (p) => {
