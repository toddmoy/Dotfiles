...
suite('Should jump-to-definition', () => {
    ...
    test('Diagnoses jump from attribute to model', () => __awaiter(void 0, void 0, void 0, function* () {
        yield testJumpToDefinition(docUri, new vscode_1.default.Position(22, 9), new vscode_1.default.Location(docUri, helper_1.toRange(9, 6, 9, 10)));
        yield testJumpToDefinition(docUri, new vscode_1.default.Position(14, 14), new vscode_1.default.Location(docUri, helper_1.toRange(18, 6, 18, 10)));
    }));
});
