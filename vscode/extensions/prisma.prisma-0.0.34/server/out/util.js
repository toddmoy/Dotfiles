 ...
 * Get the exec path
 */
function getSdkQueryEnginePath() {
    return __awaiter(this, void 0, void 0, function* () {
        platform = platform || (yield get_platform_1.getPlatform());
        version = version || (yield getVersion());
        const extension = platform === 'windows' ? '.exe' : '';
        const sdkDir = path_1.default.dirname(require.resolve('@prisma/sdk/package.json'));
        return path_1.default.join(sdkDir, `query-engine-${platform}${extension}`);
    });
}
exports.getSdkQueryEnginePath = getSdkQueryEnginePath;
/**
