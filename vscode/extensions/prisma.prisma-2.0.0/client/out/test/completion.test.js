...
suite('Should auto-complete', () => {
    ...
    test('Diagnoses block type suggestions with sqlite as provider', () => __awaiter(void 0, void 0, void 0, function* () {
        yield testCompletion(sqliteDocUri, new vscode_1.default.Position(4, 0), new vscode_1.default.CompletionList([
            ...
            { label: 'type_alias', kind: vscode_1.default.CompletionItemKind.Class },
        ], false), false);
    }));
    ...
    const fieldBinaryTargets = { label: 'binaryTargets', kind: vscode_1.default.CompletionItemKind.Field };
    ...
    test('Diagnoses generator field suggestions in empty block', () => __awaiter(void 0, void 0, void 0, function* () {
        yield testCompletion(emptyBlocksUri, new vscode_1.default.Position(5, 0), new vscode_1.default.CompletionList([fieldBinaryTargets, fieldOutput, fieldProvider]), false);
    }));
    ...
    test('Diagnoses arguments of @relation directive', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield testCompletion(relationDirectiveUri, new vscode_1.default.Position(12, 26), new vscode_1.default.CompletionList([
            { label: '""', kind: vscode_1.default.CompletionItemKind.Property },
            fieldsProperty,
            referencesProperty,
        ]), true);
        ...
        yield testCompletion(relationDirectiveUri, new vscode_1.default.Position(30, 44), new vscode_1.default.CompletionList([fieldsProperty]), true);
        yield testCompletion(relationDirectiveUri, new vscode_1.default.Position(39, 45), new vscode_1.default.CompletionList([referencesProperty]), true);
